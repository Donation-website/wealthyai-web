...
export async function generateAccessConfirmationPDF({ productName, amount, currency, date, sessionId }) {
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.rect(50, currentY, 3, 60).fill('#6366f1');
      
      doc.fillColor('#6366f1')
         .font('Helvetica-Bold')
         .fontSize(9)
         .text("YOUR UNIQUE PRIORITY ACCESS KEY:", 70, currentY + 15);

      doc.fillColor('#0f172a')
         .font('Courier-Bold')
         .fontSize(10)
         .text(`${sessionId}`, 70, currentY + 32);
      
      // Kurzor visszaállítás
      doc.y = currentY + 80;
      doc.x = 50;

      // --- HASZNÁLATI ÚTMUTATÓ (ÚJ RÉSZ) ---
      doc.moveDown(1);
      doc.font('Helvetica-Bold')
         .fontSize(10)
         .fillColor('#0f172a')
         .text("HOW TO USE YOUR ACCESS KEY");
      ...
      doc.font('Helvetica')
         ...
         .fillColor('#334155')
         .text(
           "1. Go to https://www.mywealthyai.com\n" +
           "2. Click \"HAVE A PRIORITY CODE?\" on the dashboard.\n" +
           "3. Copy and paste the Access Key exactly as shown above.\n" +
           "4. Your session will be restored immediately.\n\n" +
           "Important: Keep this key confidential. Anyone with access to this key can access your session.",
           { width: 450, align: 'left', lineGap: 3 }
         );
      ...
      doc.fontSize(7)
         .fillColor('#94a3b8')
         .text(
           "This document is a technical confirmation of access activation and does not constitute a formal tax invoice. Official financial receipts are issued separately by Stripe.",
           {
             align: 'center',
             width: 495
           }
