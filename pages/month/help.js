    ...
    <div style={page}>
      ...
      >
        <div style={container}>
          ...
          {/* ÚJ BIZTONSÁGI SZAKASZ - A TE VÉDELMED ÉRDEKÉBEN */}
          <Section title="Data Privacy & Local Storage (Important)" isMobile={isMobile}>
            WealthyAI is built with a <strong>"Privacy-First"</strong> architecture. 
            Unlike traditional apps, we do not store your sensitive financial data on our servers.
            <br /><br />
            <strong>Your device is your vault:</strong>
            <ul>
              <li>All inputs (income, expenses) and generated briefings are stored <strong>locally in your browser's memory</strong>.</li>
              <li>This ensures that no one—not even us—can see your financial status.</li>
              <li><strong>Device Limitation:</strong> Because your data is tied to your specific browser, if you switch to a different computer or phone, <strong>your past snapshots and settings will not be visible there.</strong></li>
            </ul>
            This approach provides the highest level of security available today, keeping your data entirely under your physical control.
          </Section>
          ...
          <Section title="Daily signal vs monthly briefing" isMobile={isMobile}>
            ...
            <ul>
              <li>One short sentence based on your selected region.</li>
            ...
            <br />
            <strong>Monthly Briefing (Dual-Lens)</strong>
            <ul>
              <li>Full strategic analysis generated by AI.</li>
              <li>Always provides two perspectives: <strong>Executive</strong> (high-level structure) and <strong>Directive</strong> (immediate focus).</li>
              <li>Generated only when you click “Generate AI”.</li>
              <li>Exists only in the current session unless saved.</li>
            </ul>
          </Section>

          <Section title="The Structural Stress Test" isMobile={isMobile}>
            This tool allows you to simulate financial fragility before it happens.
            <br /><br />
            By adjusting the <strong>Stress Factor</strong>, you can see how your monthly structure would react to cost increases (up to +100%). 
            The <strong>Fragility Index</strong> will calculate in real-time if your core financial rigidity is approaching a critical threshold or remains within structural limits.
          </Section>

          <Section title="Snapshots & Archive" isMobile={isMobile}>
            ...
            <br />
            Saved snapshots can be revisited later, downloaded as a <strong>PDF</strong>, or sent to your <strong>Email</strong> as a briefing report.
          </Section>
          ...
          <Section title="What this system does NOT do" isMobile={isMobile}>
            <ul>
              ...
              <li>It does not track behavior or store data on external servers.</li>
              <li>It does not notify or interrupt you.</li>
            </ul>
          </Section>

          <p style={footer}>
            WealthyAI provides awareness — not control. All data remains on your local device for your security.
          </p>
        </div>
      </div>
    </div>
